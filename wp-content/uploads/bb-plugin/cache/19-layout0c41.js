...
var wpAjaxUrl='../wp-admin/admin-ajax.html';var flBuilderUrl='../wp-content/plugins/beaver-builder-lite-version/index.html';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://www.missionworldpeace.com/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'https://www.missionworldpeace.com/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var hash=window.location.hash.replace('#','').split('../index.html').shift(),element=null,tabs=null,responsiveLabel=null,tabIndex=null,label=null;if(''!==hash){try{element=$('#'+hash);if(element.length>0){if(element.hasClass('fl-accordion-item')){setTimeout(function(){element.find('.fl-accordion-button').trigger('click');},100);}
